...
public class DateFormatUnitTest {
  ...
  public void givenGregorianCalendar_whenLocaleSpecificDateTimeInstance_givenLocaleSpecificFormatting() {
    ...
    DateFormat itInstance =
        DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.FULL, Locale.ITALY);
    DateFormat jpInstance =
        DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.FULL, Locale.JAPAN);
  ...
  public void givenGregorianCalendar_whenCustomizedDateFormatSymbols_thenChangedDayNames() {
    ...
    SimpleDateFormat newDaysDateFormat =
        new SimpleDateFormat("EEEE-MMMM-yyyy HH:mm:ss:SSS", dateFormatSymbols);
