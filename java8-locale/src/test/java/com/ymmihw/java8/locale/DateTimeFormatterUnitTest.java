package com.ymmihw.java8.locale;
...
public class DateTimeFormatterUnitTest {
  ...
  public void givenDefaultUsLocaleAndDateTimeAndPattern_whenFormatWithDifferentLocales_thenGettingLocalizedDateTimes() {
    ...
    DateTimeFormatter plTimeFormatter =
        DateTimeFormatter.ofPattern(pattern, new Locale("pl", "PL"));
    DateTimeFormatter deTimeFormatter =
        DateTimeFormatter.ofPattern(pattern).withLocale(Locale.GERMANY);
  ...
  public void givenDateTimeAndTimeZone_whenFormatWithDifferentLocales_thenGettingLocalizedZonedDateTimes() {
    ...
    String formattedDateTime =
        localizedFormatter.format(ZonedDateTime.of(localDateTime, losAngelesTimeZone));
    String frFormattedDateTime =
        frLocalizedFormatter.format(ZonedDateTime.of(localDateTime, losAngelesTimeZone));
